...
<div id="wrap">
    <!-- Start Header -->
    <header class="header v2" id="myHeader">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="logo">
                        <a href="index.php">
                            <img src="assets/images/logo.png" class="img-fluid" alt="The Conference Cuisine Logo Image">
                        </a>
                    </div>
                </div>
    ...
    <section class="home-fullwidth-slider">
        <h1 class="d-none">hidden</h1>
        <div class="slider_fullwidth">
            <ul class="bx-slider_fullwidth p-0 carousel-inner" id="fullwidth_top_slider">
                <li class="tp-slide">
                    <div class="slider-content-inner">
                        <div class="slider_bg_image" style="background-image: url(assets/images/fullwidth-slider/slider-1.png);"></div>
                        <div class="bx-slide-caption container">
                            <div class="slider-tp-content text-center">
                                <span>Tasty & Healthy</span>
                                <h2>Food Made With Love!</h2>
                                
                                <p class="mb-0 text-center-p">Welcome to Conference Cuisine, your go-to spot for delicious and satisfying meals. We offer a wide variety of options to suit all tastes and dietary needs, including vegetarian, vegan, and gluten-free options. </p>
                                <div class="slider-video-section mt-4 mt-md-5" >
                                    <div class="slider-obutton">
                                        <a href="javascript:void(0);" class="btn">Order Now</a>
                                    </div>
                                    <div class="slider-pbutton pl-3 pl-md-5">
                                        <a href="#exampleModalCenter" class="play-button" data-toggle="modal" data-target="#exampleModalCenter">
                                            <img src="assets/images/silders/paly-icon.png" alt="the Girl on the beach - best destination Image" >
                                        </a>
                                        <p class="mb-0 ml-4 text-white">Watch Our Story</p>                            
                ...
                <li class="tp-slide">
                    <div class="slider-content-inner">
                        <div class="slider_bg_image" style="background-image: url(assets/images/fullwidth-slider/slider-2.png);"></div>
                        <div class="bx-slide-caption container">
                            <div class="slider-tp-content text-center">
                                <span>Tasty & Healthy</span>
                                <h2>Food Made With Love!</h2>
                                <p class="mb-0 text-center-p" >Our menu features classic favorites as well as new and exciting dishes made with fresh, high-quality ingredients. We pride ourselves on providing friendly and efficient service, ensuring that your dining experience with us is enjoyable and stress-free. Stop by and see us today, we can't wait to serve you! </p>
                                <div class="slider-video-section mt-4 mt-md-5">
                                    <div class="slider-obutton">
                                        <a href="javascript:void(0);" class="btn">Make Reservation</a>
                                    </div>
                                    <div class="slider-pbutton pl-3 pl-md-5">
                                        <a href="#exampleModalCenter" class="play-button" data-toggle="modal" data-target="#exampleModalCenter">
                                            <img src="assets/images/silders/paly-icon.png" alt="the Girl on the beach - best destination Image" >
    ...
    <section class="specialities position-relative mt-100" id="Recipes">
        ...
        <div class="container">
            <div class="row specialities-top">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="wow fadeInDown" data-wow-duration="2s" data-wow-delay=".4s">
                     ...
                     <p class="wow fadeIn" data-wow-duration="2s" data-wow-delay=".4s">We also offer a variety of catering options for meetings and events. From boxed lunches to full buffets, we can accommodate any size group and dietary restrictions</p>
                </div>
            </div>
            <div class="row specialities-section">
                ...
                <div class="col-12 col-md-6 col-lg-6 p-lg-0 specialities-column">
                    ...
                    Our menu page includes a variety of options for breakfast, lunch, and dinner. From classic breakfast sandwiches to hearty salads and hot entrees, we have something for everyone to enjoy. Our menu is updated regularly to include seasonal items and special promotions.</p>
                </div>
            </div>
            <div class="row specialities-section">
            ...
            <div class="row specialities-top">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="wow fadeInDown" data-wow-duration="2s" data-wow-delay=".4s">
                     ...
                     <p class="wow fadeIn" data-wow-duration="2s" data-wow-delay=".4s">Here at our cafeteria, we offer both the convenience of booking meeting spaces online and ordering food online.</p>
                </div>
            </div>
            <div class="row">
...
>>>>>>> fcbc0149a8e77d310ae8b0d79b6c30879aa41025
            ...
            <div class="row specialities-top">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="wow fadeInDown" data-wow-duration="2s" data-wow-delay=".4s">
                     ...
                     <p class="wow fadeIn" data-wow-duration="2s" data-wow-delay=".4s"> Our goal is to provide delicious and nutritious meals while also offering a convenient and comfortable space for meetings and events.</p>
                </div>
            </div>
...
<!-- Mirrored from up2client.com/envato/cafe360-HTML/main-file/index-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Jan 2023 06:39:36 GMT -->
</html>